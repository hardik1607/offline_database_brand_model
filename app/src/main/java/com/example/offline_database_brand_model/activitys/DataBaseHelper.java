...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public final static String DATABASE_PATH = "/data/data/com.example.offline_database_brand_model/databases/";
    ...
    {
        SQLiteDatabase sqLiteDatabase=this.getReadableDatabase();
        String q="select * from Models where brand_id="+brand_id;
        Cursor c=sqLiteDatabase.rawQuery(q,null);
        return c;
    }
